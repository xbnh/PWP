...
- ssh into the server
    - For Mac and Linux: `ssh root@heshamelhamdani.com`
    - For Windows: Set up a new PuTTY session
        ...
        - **Session**
            ...
            - Click Save
- create user
    - `useradd -m -s /bin/bash -g users -G sudo helhamdani`
    - replace helhamdani with your own
- create password
    - `passwd helhamdani`
- Move .ssh key file
    - `cp -r .ssh /home/helhamdani`
- change ownership of the .ssh directory
    - `cd /home/helhamdani`
    - `chown -R helhamdani:users .ssh/`


- Test Changes
    - `exit`
    - Mac/Linux: `ssh helhamdani@heshamelhamdani.com`
    - Windows:
        - **Session**
            - Click pwp
            - Click Load
...
- reboot
    - `sudo reboot`
- ssh back in
- `ssh helhamdani@heshamelhamdani.com`
...
- create a directory for your deployment
    - `sudo mkdir /var/www/heshamelhamdani.com/html`
- fix permissions
    - `sudo chown -R $USER:users /var/www/heshamelhamdani.com/html`
...
- `sudo vim /etc/nginx/sites-available/heshamelhamdani.com`
...
server {
    ...
    root /var/www/heshamelhamdani.com/html;
    index index.html index.htm index.nginx-debian.html;

    server_name heshamelhamdani.com www.heshamelhamdani.com;
...
- create a symlink to the sites-enabled directory
    - `sudo ln -s /etc/nginx/sites-available/heshamelhamdani.com /etc/nginx/sites-enabled/`
...
- Create a new ssh key on your server in the .ssh directory
    - `ssh-keygen -t ed25519 -C  "github Deploy Key" -f /home/helhamdani/.ssh/github_deploy_key`
    - Don't enter a passphrase
        - hit enter twice
- Copy the public key into your authorized keys file
    - `cat /home/helhamdani/.ssh/github_deploy_key.pub >> /home/helhamdani/.ssh/authorized_keys`
...
- Copy the private key to your clipboard **(this is a very dangerous operation do not share this key with anyone )**
    ...
    - `cat /home/helhamdani/.ssh/github_deploy_key`
  ...
  deploy:
    ...
    steps:
      ...
      - name: Deploy to server
        run: |
         ssh-keyscan -H heshamelhamdani.com >> ~/.ssh/known_hosts 
         scp -r ./dist/* helhamdani@heshamelhamdani.com:/var/www/heshamelhamdani.com/html
```
